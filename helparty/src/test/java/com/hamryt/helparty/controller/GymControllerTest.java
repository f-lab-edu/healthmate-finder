...
class GymControllerTest {
    ...
    @Test
    @DisplayName("운동시설 관리자 계정 생성 성공하면 해당 계정 정보르 반환한다.")
    public void create_Success() throws Exception {
        ...
        mvc.perform(post("/gyms")
            ...
            .content(
                "{ \"email\":\"test@example.com\", \"gymName\":\"testGym\", \"password\":\"123\", \"phoneNumber\":\"01012345678\", \"addressCode\":\"1234\", \n"
                    + " \"addressDetail\":\"Seoul\", \"userType\":\"GYM\"}"))
